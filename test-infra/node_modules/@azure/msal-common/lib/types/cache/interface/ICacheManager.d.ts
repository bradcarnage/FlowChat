...
export interface ICacheManager {
     ...
     * @param accessToken
     */
    setAccessTokenCredential(accessToken: AccessTokenEntity, correlationId: string): void;
    /**
     * fetch the idToken entity from the platform cache
     ...
     * @param refreshToken
     */
    setRefreshTokenCredential(refreshToken: RefreshTokenEntity, correlationId: string): void;
    /**
