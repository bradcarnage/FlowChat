...
'use strict';
import { Logger, buildStaticAuthorityOptions, AuthorizationCodeClient, AuthenticationScheme, ResponseMode, AuthError, RefreshTokenClient, SilentFlowClient, createClientAuthError, ClientAuthErrorCodes, Constants, getClientAssertion, StringUtils, OIDC_DEFAULT_SCOPES, ServerTelemetryManager, Authority, AuthorityFactory } from '@azure/msal-common/node';
