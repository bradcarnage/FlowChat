...
|----------|-------------|--------|
| Fabric (client) | 1.14.4, 1.15.2, 1.16.5, 1.17.1, 1.18.2, 1.19.2, 1.19.4, 1.20.1, 1.20.4, 1.20.6, 1.21.1, 1.21.4 | `multiplatform/<version>` |
| Spigot / Paper (server) | 1.13+ | `multiplatform/1.21.4` |
...
3. Download the FlowChat JAR for your MC version from [Releases](https://github.com/bradcarnage/FlowChat/releases)
...
2. Download `flowchat-spigot-2.1.0.jar` from [Releases](https://github.com/bradcarnage/FlowChat/releases)
...
2. Download `flowchat-bungee-2.1.0.jar` from [Releases](https://github.com/bradcarnage/FlowChat/releases)
3. Drop it in your BungeeCord `plugins/` folder
4. Restart the proxy

### Velocity (Proxy Plugin)

1. Download `flowchat-velocity-2.1.0.jar` from [Releases](https://github.com/bradcarnage/FlowChat/releases)
